...
def test_validate_ff_request_lookup(test_client_factory):
    data = {
        'settings': {
            'item': {
                'id': 'id',
    ...
    response = client.post('/api/lookup_ff_request/validate', json=data)
...
def test_validate_ff_request_lookup_with_asset(test_client_factory):
    data = {
        'settings': {
            'item': {
                'id': 'id',
...
def test_validate_ff_request_lookup_invalid_basic_structure(test_client_factory):
    data = {
        'columns': {
            'input': [
                {'name': 'Request ID'},
...
def test_validate_ff_request_lookup_invalid_settings(test_client_factory):
    data = {
        'settings': {
            'item': {
                'id': 'id',
...
def test_validate_ff_request_lookup_invalid_asset_type(test_client_factory):
    data = {
        'settings': {
            'item': {
                'id': 'id',
...
def test_validate_ff_request_lookup_invalid_action_if_not_found(test_client_factory):
    data = {
        'settings': {
            'item': {
                'id': 'id',
...
def test_validate_ff_request_lookup_invalid_action_if_multiple(test_client_factory):
    data = {
        'settings': {
            'item': {
                'id': 'id',
...
def test_validate_ff_request_lookup_invalid_parameter(test_client_factory):
    data = {
        'settings': {
            'item': {
                'id': 'id',
...
def test_validate_ff_request_lookup_invalid_item(test_client_factory):
    data = {
        'settings': {
            'item': {
                'name': 'Item ID',
...
def test_validate_ff_request_lookup_invalid_settings_column(test_client_factory):
    data = {
        'settings': {
            'item': {
                'id': 'id',
...
def test_validate_ff_request_lookup_invalid_output_config(test_client_factory):
    data = {
        'settings': {
            'item': {
                'id': 'id',
...
@pytest.mark.asyncio
async def test_get_ff_parameters(
    test_client_factory,
    ...
    client = test_client_factory(TransformationsWebApplication)
    response = client.get('/api/lookup_ff_request/parameters?product_id=PRD-123-123')
